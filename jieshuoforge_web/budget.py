...
log = logging.getLogger("jieshuoforge_web.budget")
...
# as jieshuo_llm_stage_* series so spend/tokens split by the MAP (understand) vs REDUCE
...
class StageUsageLedger:
    ...
    collector as ``jieshuo_llm_stage_*``. Purely for attribution metrics — separate from
