"""Stage 7 — 解说 narration (Claude REDUCE pass).
...
log = logging.getLogger("jieshuoforge.s07")
...
def run_stage(
    ...
    *,
    ...
    log.info("[script] %d lines, ~%.0fs narration", len(script.lines), script.total_est_seconds)
    return script
